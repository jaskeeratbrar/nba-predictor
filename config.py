...
WEIGHTS = {
    "win_pct":          0.20,   # Overall season win percentage (reduced to make room for new factors)
    "recent_form":      0.20,   # Last 10 games performance
    "player_form":      0.20,   # Individual player performance last 5 games
    "home_away":        0.11,   # Home court advantage / road record
    "injuries":         0.14,   # Key player availability
    "net_rating":       0.05,   # NEW: avg point differential last 10 games (2026-03-22)
    "defense":          0.07,   # NEW: avg opponent PPG allowed last 10 games (2026-03-22)
    "rest_days":        0.00,   # Excluded from confidence (33% accuracy); used only for edge scoring
    "streak":           0.03,   # Current win/loss streak
}
